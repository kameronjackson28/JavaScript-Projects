...
function placeXOrO(squareNumber) {
    ...
    //The .some() method is used ot check each element of selectedSquare array
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //This condition allows our while loop to keep to keep
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indicates where to start a lines x axis is.
    let x1= coordX1,
    //This line indicates where the start of a lines y axis is.
    y1= coordY1, 
    //This line indicates where the end of a lines x axis is.
    x2=coordX2,
    //This line where the end of a lines y axis is.
    y2=coordY2,
    ...
    function animateLineDrawing() {
        //This variable creates the loop for when teh game ends it restarts.
        ...
        if(x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //This condition cancels our loop if reach the end points.
...
function resetGame() {
    ...
    for(let i = 0; i < 9; i++) {
        //This variable gets the element html element of i.
        let square = document.getElementById(String(i));
        //This removes our elements backgroundImage.
        square.style.backgroundImage = '';
    }
    //This resets our array so it's empty and we can start over.
    selectedSquares=[];
}